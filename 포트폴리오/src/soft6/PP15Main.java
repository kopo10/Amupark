...
public class PP15Main {
	...
	public static void main(String[] args) {
		...
		for (int k_10_i = 1; k_10_i <= k_10_iPerson; k_10_i++) { // 사람수만큼 반복
			...
			k_10_indata.SetData(k_10_i, k_10_name, k_10_kor, k_10_eng, k_10_mat); // 나온 값을 SetData에 입력
		}
		...
		for (int k_10_i = 1; k_10_i <= k_10_iPerson; k_10_i++) { // 사람 수만큼 반복
			...
			System.out.printf("%03d %8s %6d %8d %8d %8d %8.0f\n", k_10_indata.k_10_i[k_10_i - 1], //indata에 넣은 값을 반복 출력
			...
			if ((k_10_i % 30 == 0 && k_10_i != 0)) { //30마다 평균 계산
				for (int k_10_k = k_10_i - 30; k_10_k < k_10_i; k_10_k++) {
					k_10_kor30 += k_10_indata.k_10_kor[k_10_k]; //30명에 대한 국어 총합을 구하기 위한 변수
					k_10_mat30 += k_10_indata.k_10_mat[k_10_k]; //30명에 대한 수학 총합을 구하기 위한 변수
					k_10_eng30 += k_10_indata.k_10_eng[k_10_k]; //30명에 대한 영어 총합을 구하기 위한 변수
				}
				...
				double k_10_total30ave = (k_10_kor30 + k_10_mat30 + k_10_eng30) / 3; //반의 평균
				int k_10_total31 = k_10_kor31 + k_10_mat31 + k_10_eng31;
				double k_10_total31ave = (k_10_kor31 + k_10_mat31 + k_10_eng31) / 3; //총합의 평균
				...
				System.out.printf("합계%18d  %7d   %6d   %6d  %7.0f\n", k_10_kor31, k_10_eng31, k_10_mat31, k_10_total31,	 // ( ) 출력
						k_10_total31ave);
				System.out.printf("평균%18d  %7d   %6d   %6d  %7.0f\n", k_10_kor31 / k_10_i, k_10_eng31 / k_10_i, k_10_mat31 / k_10_i,
						k_10_total31 / k_10_i, k_10_total31ave / k_10_i);													  // ( ) 출력

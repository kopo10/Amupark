...
public class PP10OneRec {																						//학번, 점수들을 위한 변수를 선언해준다
	...
	public PP10OneRec (int k_10_student_id, String k_10_name, int k_10_kor, int k_10_eng, int k_10_mat) {		// 받은 인자들을 선언한 변수에 정의해준다
